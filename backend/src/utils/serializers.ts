...
export function serializeParkingSession(session: any) {
  return {
    ...
    paymentLookupCode: session.paymentLookupCode,
    qrCode: session.qrCode,
    qrExpiry: session.qrExpiry,
    barrierTriggered: Boolean(session.barrierTriggered),
    barrierTriggeredAt: session.barrierTriggeredAt,
    barrierAction: session.barrierAction,
