...
export function serializeParkingSession(session: ParkingSessionDocument) {
  return {
    ...
    expectedExitRfidUid: session.expectedExitRfidUid,
    entryRfidUid: session.entryRfidUid,
    ...
    checkInStaff: session.checkInStaff?.toString(),
    checkOutStaff: session.checkOutStaff?.toString(),
    ...
    visualConfirmedBy: session.visualConfirmedBy?.toString(),
    visualConfirmedAt: session.visualConfirmedAt?.toISOString(),
    entryRfidUnverified: session.entryRfidUnverified,
    exitRfidManualVerified: session.exitRfidManualVerified,
    cashNote: session.cashNote,
    collectedBy: session.collectedBy?.toString(),
  };
}
...
export function serializeDevice(device: DeviceDocument) {
  return {
    ...
    roi: (device.roi as Record<string, unknown> | undefined) ?? null,
