...
import { staffApplicationsRoutes } from "./staffApplications.routes.js";
...
import {
  cameraBridgeAdminRoutes,
  cameraBridgeRoutes,
} from "./camera-bridge.routes.js";
...
apiRoutes.use("/staff-applications", staffApplicationsRoutes);
...
apiRoutes.use("/disputes", disputesRoutes);
