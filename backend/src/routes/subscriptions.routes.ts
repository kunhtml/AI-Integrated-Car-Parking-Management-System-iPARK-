...
subscriptionsRoutes.put(
  ...
  requireAuth,
  requireRole("admin"),
  asyncHandler(updatePlanHandler),
);
...
subscriptionsRoutes.get(
  "/my",
  requireAuth,
  asyncHandler(mySubscriptionsHandler),
);
subscriptionsRoutes.post("/", requireAuth, asyncHandler(purchaseHandler));
subscriptionsRoutes.post(
  "/verify-member",
  requireAuth,
  asyncHandler(verifyMemberCodeHandler),
);
subscriptionsRoutes.get(
  "/:id/payment-status",
  requireAuth,
  asyncHandler(subscriptionPaymentStatusHandler),
);
subscriptionsRoutes.get(
  "/:id/payment-info",
  requireAuth,
  asyncHandler(getPaymentInfoHandler),
);
