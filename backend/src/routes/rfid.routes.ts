...
import {
  ...
  sellForCustomer,
  reconcilePending,
  reconcileCustomerSale,
  cardDetails,
  transactions,
  updateStatus,
} from "../controllers/rfidSales.controller.js";
...
import {
  ...
  listRfidIssues,
  updateRfidIssue,
} from "../controllers/rfidIssue.controller.js";
import {
  assignPurchaseCard,
  ...
  payPurchaseRequest,
  reconcilePurchaseRequest,
  reviewPurchaseRequest,
} from "../controllers/rfidPurchase.controller.js";
...
rfidRoutes.post(
  "/purchase-requests/:id/reconcile",
  asyncHandler(reconcilePurchaseRequest),
);
rfidRoutes.get(
  "/purchase-requests",
  requireRole("admin", "staff"),
  asyncHandler(listPurchaseRequests),
);
rfidRoutes.post(
  "/purchase-requests/:id/review",
  requireRole("admin", "staff"),
  asyncHandler(reviewPurchaseRequest),
);
rfidRoutes.post(
  "/purchase-requests/:id/assign",
  requireRole("admin", "staff"),
  asyncHandler(assignPurchaseCard),
);
...
rfidRoutes.get(
  ...
  asyncHandler(listRfidIssues),
);
rfidRoutes.patch(
  "/issue-requests/:id",
  requireRole("admin", "manager"),
  asyncHandler(updateRfidIssue),
);
rfidRoutes.get(
  "/inventory",
  requireRole("admin", "staff"),
...
rfidRoutes.post(
  "/sales/:transactionId/confirm",
  requireRole("admin", "staff"),
  asyncHandler(confirmSale),
);
rfidRoutes.post(
  "/sales/reconcile-pending",
  requireRole("admin", "staff"),
  asyncHandler(reconcilePending),
);
rfidRoutes.post(
  "/my-sales/:transactionId/reconcile",
  asyncHandler(reconcileCustomerSale),
);
rfidRoutes.post(
  "/:id/return",
  requireRole("admin", "staff"),
  asyncHandler(returnCard),
);
rfidRoutes.post(
  "/:id/replace",
  requireRole("admin", "staff"),
  asyncHandler(replaceCard),
);
rfidRoutes.get("/", requireRole("admin", "staff"), asyncHandler(listRfidCards));
rfidRoutes.get(
  "/assignments",
  requireRole("admin", "staff"),
  asyncHandler(listRfidAssignments),
);
rfidRoutes.get(
...
rfidRoutes.get(
  "/by-plate/:plate",
  requireRole("admin", "staff"),
  asyncHandler(lookupByPlate),
);
rfidRoutes.get(
  "/by-uid/:uid",
  requireRole("admin", "staff"),
  asyncHandler(lookupByUid),
);
rfidRoutes.post(
  "/replace-active",
  requireRole("admin", "staff"),
  asyncHandler(replaceActiveSessionRfid),
);
...
rfidRoutes.post(
  "/:id/restore",
  requireRole("admin"),
  asyncHandler(restoreRfidCard),
);
rfidRoutes.post(
  "/:id/status",
  requireRole("admin", "staff"),
  asyncHandler(setRfidCardStatus),
);
rfidRoutes.post(
  "/:id/:action",
  requireRole("admin", "staff"),
