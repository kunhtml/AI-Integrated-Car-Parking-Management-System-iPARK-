...
const listQuerySchema = z.object({
  limit: z.coerce.number().int().min(1).max(RECOGNITION_LOGS_MAX_LIMIT).optional(),
...
export async function listRecognitionLogsHandler(request: Request, response: Response) {
