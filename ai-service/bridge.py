...
ESP32_IN_PORT = os.environ.get("ESP32_IN_PORT", os.environ.get("SERIAL_PORT_IN", "COM3"))
ESP32_OUT_PORT = os.environ.get("ESP32_OUT_PORT", os.environ.get("SERIAL_PORT_OUT", "COM5"))
